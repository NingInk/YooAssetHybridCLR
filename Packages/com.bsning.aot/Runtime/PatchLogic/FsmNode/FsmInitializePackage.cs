...
internal class FsmInitializePackage : IStateNode
{
    ...
    private string GetHostServerURL()
    {
        ...
        string hostServerIP = "http://192.168.1.2:8080";
        string platform =
#if UNITY_EDITOR
            UnityEditor.EditorUserBuildSettings.activeBuildTarget switch
            {
...
#endif
        return $"{hostServerIP}/{Application.productName}/{platform}";
    }
